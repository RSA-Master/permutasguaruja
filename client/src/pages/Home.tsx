...
const detailImage = "/assets/permutas/carrossel-permutas-card-04.webp";
...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="practical-example section-light" id="exemplo-pratico"><div className="container"><div className="section-heading"><div><p className="eyebrow"><span /> Exemplo prático</p><h2>Imagine esta <em>situação.</em></h2></div><p>Uma história ilustrativa para entender como uma permuta pode resolver uma necessidade real sem comprometer o caixa.</p></div><div className="trade-carousel reveal-stagger" ref={tradeCarouselRef} aria-label="Jornada ilustrativa de uma permuta entre uma loja e um profissional" onPointerDown={handleTradePointerDown} onPointerMove={handleTradePointerMove} onPointerUp={handleTradePointerEnd} onPointerCancel={handleTradePointerEnd} onPointerLeave={handleTradePointerEnd}><div className="trade-track trade-track--six" data-active-slide={tradeSlide} style={{ transform: "none" }}><article className="trade-card trade-card--visual"><img className="trade-card-image" src="/assets/permutas/carrossel-permutas-card-01.webp" alt="Proprietária em sua loja de roupas refletindo sobre melhorias" /><div className="trade-card-caption"><span className="trade-index">01 / 06</span><p className="card-kicker">O ponto de partida</p><h3>Uma loja para melhorar</h3><strong>A proprietária quer deixar o espaço ainda mais bonito e funcional.</strong></div></article><article className="trade-card trade-card--visual"><img className="trade-card-image" src="/assets/permutas/carrossel-permutas-card-02.webp" alt="Proprietária procurando profissionais disponíveis para permuta no grupo" /><div className="trade-card-caption"><span className="trade-index">02 / 06</span><p className="card-kicker">A busca começa</p><h3>Ela procura no grupo</h3><strong>Profissionais disponíveis para realizar um serviço por permuta.</strong></div></article><article className="trade-card trade-card--visual"><img className="trade-card-image" src="/assets/permutas/carrossel-permutas-card-03.webp" alt="Profissional de obras com um horário disponível na agenda" /><div className="trade-card-caption"><span className="trade-index">03 / 06</span><p className="card-kicker">O profissional também ganha</p><h3>Preenche um horário</h3><strong>Um serviço que ocuparia um espaço vazio na agenda.</strong></div></article><article className="trade-card trade-card--visual"><img className="trade-card-image" src="/assets/permutas/carrossel-permutas-card-04.webp" alt="Profissional realizando o rebaixamento de teto dentro da loja" /><div className="trade-card-caption"><span className="trade-index">04 / 06</span><p className="card-kicker">A troca acontece</p><h3>O serviço é realizado</h3><strong>O rebaixamento de teto melhora o ambiente da loja.</strong></div></article><article className="trade-card trade-card--visual"><img className="trade-card-image" src="/assets/permutas/carrossel-permutas-card-05.webp" alt="Loja oferecendo créditos para consumo em seus produtos" /><div className="trade-card-caption"><span className="trade-index">05 / 06</span><p className="card-kicker">Sem comprometer o caixa</p><h3>Créditos para consumir</h3><strong>A loja oferece produtos no valor negociado pelo serviço.</strong></div></article><article className="trade-card trade-card--visual"><img className="trade-card-image" src="/assets/permutas/carrossel-permutas-card-06.webp" alt="Duas participantes celebrando uma permuta que gera contatos e oportunidades" /><div className="trade-card-caption"><span className="trade-index">06 / 06</span><p className="card-kicker">O resultado</p><h3>Todos saem ganhando</h3><strong>A permuta gera valor, contatos e novas oportunidades.</strong></div></article></div><div className="trade-carousel-controls"><button type="button" aria-label="Etapa anterior" onClick={() => setTradeSlide((slide) => (slide - 1 + 6) % 6)}><ArrowLeft size={17} /></button><div className="trade-dots" aria-label={`Etapa ${tradeSlide + 1} de 6`}>{Array.from({ length: 6 }, (_, dot) => <button type="button" key={dot} aria-label={`Ir para etapa ${dot + 1}`} aria-current={tradeSlide === dot} onClick={() => setTradeSlide(dot)} />)}</div><button type="button" aria-label="Próxima etapa" onClick={() => setTradeSlide((slide) => (slide + 1) % 6)}><ArrowRight size={17} /></button></div></div><p className="trade-note">A negociação depende do interesse e das condições acordadas entre as partes. <strong>Cada permuta é combinada diretamente pelos participantes.</strong></p></div></section>
      ...
      <section className="faq-section section-light" id="faq">
        <div className="container faq-layout">
          <div className="section-heading">
            <div><p className="eyebrow"><span /> Perguntas frequentes</p><h2>Antes de <em>participar.</em></h2></div>
            <p>As principais dúvidas de quem está conhecendo o Projeto Permutas Guarujá.</p>
          </div>
